...
type ThingInclusionReport struct {
	...
	CommTechnology string `json:"comm_tech"`       // Technology used by the adapter to communicate with the device. Possible values: "zw", "zigbee". TODO: work out conventions for cloud and local network adapters.
