...
func TestMqttTransport_Publish(t *testing.T) {
	...
	adr := Address{MsgType: fimptype.MsgTypeEvt, ResourceType: fimptype.ResourceTypeDevice, ResourceName: "test", ResourceAddress: "1", ServiceName: "temp_sensor", ServiceAddress: "300"}
...
func TestMqttTransport_SubUnsub(t *testing.T) {
	...
	msg := NewFloatMessage("evt.sensor.report", "temp_sensor", float64(35.5), nil, nil, nil)
	adr := Address{PayloadType: DefaultPayload, MsgType: fimptype.MsgTypeEvt, ResourceType: fimptype.ResourceTypeDevice, ResourceName: "test", ResourceAddress: "1", ServiceName: "temp_sensor", ServiceAddress: "300"}
	err = mqtt.PublishSync(&adr, msg)
	if err != nil {
...
func TestMqttTransport_TestResponder(t *testing.T) {
	...
	addr := Address{PayloadType: DefaultPayload, MsgType: fimptype.MsgTypeCmd, ResourceType: fimptype.ResourceTypeApp, ResourceName: "test", ResourceAddress: "1"}
